...
// asynchronous operations.  The transition from step to step is triggered
// by the event emitter object performing the async ops.
//
...
/**
 * Initialize sequencer object and attach a listener to each of the
 * events that the api object might emit that should lead to the
 * next step.
 *
